...
deddd
        ...
        begin
          ...
          event << "#{royaloakap.config['emoji_warning']} Failed to DM user about kick reason. " \
                   'Kicking anyway...'
        end
        ...
        event << " #{royaloakap.config['emoji_success']} #{member.name} has been ejected."
      },
    ...
    royaloakap.crb.add_command(
      ...
      code: proc { |event, args|
        ...
        begin
          ...
          event << "#{royaloakap.config['emoji_warning']} Failed to DM user about ban reason. " \
                   'Banning anyway...'
        end
        begin
        ...
        event << "#{royaloakap.config['emoji_success']} The banhammer was hit on #{member.name}!"
      },
      triggers: %w[ban],
