  ...
  module Mod
    royaloakap.crb.add_command(
      ...
      code: proc { |event, args|
        ...
        warning = royaloakap.config['emoji_warning']
        ...
        begin
          ...
          info_msg.edit("#{royaloakap.config['emoji_error']} Message delete failed!\n" \
                        'Check the permissions?')
          next
        end

        info_msg.edit("#{royaloakap.config['emoji_clear']} Cleared #{message_count} messages!\n" \
