  ...
  module Extra
    if royaloakap.config['extra_commands']
      ...
      json_food_commands.each do |x|
        ...
        puts "Added food command for #{x}!" if royaloakap.config['verbose']
      end
      royaloakap.crb.commands[:brekkie][:triggers].push('breakfast', 'brekky', 'give breakfast to ',
      ...
      puts 'Added fun command for random question!' if royaloakap.config['verbose']
      ...
      puts 'Added fun command for nextzeldagame!' if royaloakap.config['verbose']
      ...
      puts 'Added fun command for wouldyourather!' if royaloakap.config['verbose']
      ...
      puts 'Added fun command for fact!' if royaloakap.config['verbose']
      ...
      puts 'Added fun command for cats!' if royaloakap.config['verbose']
      royaloakap.crb.add_command(
        :catgifs,
        code: proc { |event, _|
          gif_url = nil
      ...
      puts 'Added fun command for catgifs!' if royaloakap.config['verbose']
      ...
      puts 'Added fun command for fight!' if royaloakap.config['verbose']
    end
  end
end
