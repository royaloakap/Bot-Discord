...
module royaloakap
  ...
  if File.exist?(config_file)
    ...
    !! If you\'re under Docker, try \'docker-compose run royaloakap ruby config.rb\'    !!'
  ...
  default_haste_instance = 'https://haste.Royaloakap.uk'
  ...
  def self.build_init
    # Transfer it into an init hash.
    {
      ...
      ready: proc { |event|
        ...
        royaloakap::Statistics.register_statistics_callbacks event.bot
      }
    }
  end
end
